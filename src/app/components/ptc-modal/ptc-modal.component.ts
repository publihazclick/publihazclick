          ...
          <div class="px-4 pb-4 pt-3 bg-zinc-950 overflow-y-auto">
            @if (alreadyViewed()) {
              ...
              <div class="text-center">
                <div class="w-16 h-16 mx-auto mb-3 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
                ...
                <p class="text-slate-500 text-xs mt-1">
                  <span class="text-emerald-400 font-bold">{{ rewardDisplay() }}</span> agregados a tu wallet
                </p>
                <button (click)="onClose()" class="mt-4 w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-black rounded-xl text-sm uppercase tracking-wider">
                  Continuar
                </button>
              </div>
            } @else {
