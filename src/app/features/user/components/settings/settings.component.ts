...
export class UserSettingsComponent implements OnInit {
  ...
  // Use the shared service signal so layout avatar updates automatically
  ...
  async onAvatarChange(event: Event): Promise<void> {
    ...
    if (updated) {
      this.avatarPreview.set(null); // profile().avatar_url is now updated in the service signal
