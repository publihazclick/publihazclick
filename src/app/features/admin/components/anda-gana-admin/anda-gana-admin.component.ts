  ...
  template: `
    <div class="min-h-screen w-full flex flex-col items-center justify-center py-16 px-4">
      <div class="flex flex-col items-center gap-6 text-center max-w-sm">
        ...
        <div>
          <h1 class="text-white font-black text-2xl mb-2">Anda y Gana — Admin</h1>
          <p class="text-slate-400 text-sm leading-relaxed">Próximamente disponible.</p>
        </div>
      </div>
    </div>
  `,
})
export class AndaGanaAdminComponent {}
