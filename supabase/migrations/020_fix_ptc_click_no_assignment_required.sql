-- =============================================================================
-- Migration 020: Fix record_ptc_click — sin dependencia de daily_task_assignments
-- Dedup via ptc_clicks.completed_at, límites diarios por ad_type, recompensas fijas
-- =============================================================================
