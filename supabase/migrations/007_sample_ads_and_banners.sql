-- =============================================
-- Sample PTC Tasks and Banners Data
-- =============================================

-- Check table structure first
SELECT column_name, data_type FROM information_schema.columns 
WHERE table_name = 'ptc_tasks' ORDER BY ordinal_position;

SELECT column_name, data_type FROM information_schema.columns 
WHERE table_name = 'banner_ads' ORDER BY ordinal_position;

-- Insert sample PTC Tasks (correct table name)
-- Using NULL for advertiser_id since these are system ads (not tied to a specific user profile)
...
VALUES 
  (
    ...
    50, 30, 100, 0, 'active', 'mega', 'app', NOW()
  ),
  (
    ...
    40, 25, 80, 0, 'active', 'standard_600', 'app', NOW()
  ),
  (
    'Gran Venta de Electrónicos',
    'Hasta 50% de descuento en electrónicos',
    'https://example.com/electronicos',
    'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=400&h=300&fit=crop',
    35, 20, 60, 0, 'active', 'standard_400', 'app', NOW()
  ),
  (
    'Spa & Wellness Centro',
    ...
    30, 15, 50, 0, 'active', 'mini', 'app', NOW()
  ),
  (
    'Academia de Idiomas',
    ...
    25, 15, 40, 0, 'active', 'mini', 'app', NOW()
  ),
  (
    'Gimnasio FitLife',
    ...
    45, 25, 70, 0, 'active', 'standard_600', 'app', NOW()
  ),
  (
    'Veterinaria PetCare',
    ...
    35, 20, 55, 0, 'active', 'standard_400', 'app', NOW()
  ),
  (
    ...
    50, 30, 90, 0, 'active', 'mega', 'app', NOW()
  )
ON CONFLICT DO NOTHING;

-- Insert sample Banner Ads (correct table name)
-- Using NULL for advertiser_id since these are system banners
INSERT INTO banner_ads (name, description, image_url, url, position, impressions_limit, clicks_limit, daily_impressions, daily_clicks, total_impressions, total_clicks, reward, ctr, status, location, created_at, updated_at)
VALUES 
  (
...
SELECT 'PTC Tasks' as table_name, COUNT(*) as count FROM ptc_tasks
UNION ALL
SELECT 'Banner Ads', COUNT(*) FROM banner_ads;
