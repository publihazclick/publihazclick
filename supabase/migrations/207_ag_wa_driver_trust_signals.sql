-- =============================================================================
-- Migración 207: Fase 4 de la humanización del canal WhatsApp de Movi.
--
-- Agrega el conteo de viajes completados del conductor (metric_trips_completed,
-- ya existente en ag_drivers) al aviso de "oferta recibida" -- junto con el
-- rating que ya se mandaba, esto le da al pasajero una señal de confianza real
-- ("⭐ 4.8 · 32 viajes") en vez de solo ver un nombre y un precio.
-- =============================================================================
